...
import {View, Alert, StyleSheet, Text, Dimensions, Image} from 'react-native';
  ...
  render() {
    return (
      <View
        ...
        <ScrollView>
          <BarisInfoDP pertanyaan="Status Pesanan" jawaban="Belum Konfirmasi" />
          <BarisInfoDP
          ...
          <BarisInfoDP
            ...
            jawaban={'(+62) ' + this.state.pesanan.notelp_pelanggan}
          />
          <Text style={styles.judul}>Data Pembeli</Text>
          <BarisInfoDP
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      onPress: () => {
                        ...
                        tambahPesanan2(newPesanan)
                          .then(() =>
                            deletePesanan1(this.state.pesanan.pesanan_id)
                              .then(() => {
